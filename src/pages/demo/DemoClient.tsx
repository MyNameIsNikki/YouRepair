        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-7xl">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-2 text-sm text-gray-600 mb-4">
              ...
              <span className="text-[#6C584C]">Демо для заказчика</span>
            </div>
            
            <div className="bg-gradient-to-r from-[#ADC178] to-[#A98467] rounded-2xl p-8 text-white mb-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <p className="text-sm text-blue-800">
                <span style={{ fontWeight: '600' }}>Демо-режим для заказчика:</span> Вы можете просматривать комнаты, 
                задачи, материалы и медиа-файлы. Формируйте отчеты и создавайте тикеты (демо).
              </p>
            </div>
          </div>
            ...
            {apartment.rooms.map((room) => {
              ...
              return (
                <Card 
                  ...
                  onClick={() => navigate(`/demo/client/room/${room.id}`)}
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <Badge className="bg-[#DDE5B6] text-[#6C584C]">
                        {stats.total} задач
                      </Badge>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="flex justify-between text-sm mb-2">
                        ...
                        <span className="text-[#ADC178]" style={{ fontWeight: '600' }}>
                          {Math.round(progress)}%
                        </span>
                      </div>
                      <div className="w-full bg-gray-200 rounded-full h-2">
                        <div 
                          className="bg-[#ADC178] h-2 rounded-full transition-all duration-300"
                    ...
                    <Button 
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/demo/client/room/${room.id}`);
                      }}
                    >
                      Открыть комнату
